...
namespace KUKULCAN.SharedKernel.i18n.Migrations.SqlServer;

/// <summary>
/// Creates <see cref="I18NDbContext"/> for SQL Server EF Core design-time operations.
/// </summary>
public sealed class I18NDbContextDesignTimeFactory : IDesignTimeDbContextFactory<I18NDbContext>
{
    ...
    public I18NDbContext CreateDbContext(string[] args)
    {
        ...
        configuration["Kukulcan:Database:Provider"] = nameof(DatabaseProvider.SqlServer);
